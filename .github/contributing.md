...
-  If you find a bug, please search for it in the [Issues](/issues), and if it isn't already tracked,
   [create a new issue](/issues/new). Fill out the "Bug Report" section of the issue template. Even if an Issue is closed, feel free to comment and add details, it will still
   be reviewed.
...
-  If you'd like to improve the tests, you want to make the documentation clearer, you have an
  ...
  -  If not, [open an Issue](/issues/new) to discuss the idea first.
...
- [x] You must have signed the [Contributor License Agreement (CLA)](https://cla-assistant.io/slackapi/bolt-examples-aws-re-invent-2020).
